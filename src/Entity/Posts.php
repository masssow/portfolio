...
class Posts
{
    ...
    private ?CategoriePosts $categoriePosts = null;
    ...
    public function getCategoriePosts(): ?CategoriePosts
    {
        return $this->categoriePosts;
    }

    public function setCategoriePosts(?CategoriePosts $categoriePosts): static
    {
        $this->categoriePosts = $categoriePosts;
