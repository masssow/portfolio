...
final class Version20250914071726 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE consent_log (id INT AUTO_INCREMENT NOT NULL, consent_id VARCHAR(255) DEFAULT NULL, status VARCHAR(255) DEFAULT NULL, categories LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', ip_hash VARCHAR(255) DEFAULT NULL, user_agent VARCHAR(255) DEFAULT NULL, policy_version VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE quote (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, company VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, pack VARCHAR(255) DEFAULT NULL, budget VARCHAR(255) DEFAULT NULL, message LONGTEXT NOT NULL, locale VARCHAR(255) NOT NULL, ip VARCHAR(255) NOT NULL, user_agent VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', status VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
